        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NovelaVisualId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comentarios_Novelas_NovelaVisualId",
                        column: x => x.NovelaVisualId,
                        principalTable: "Novelas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NovelaVisualId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Resenas_Novelas_NovelaVisualId",
                        column: x => x.NovelaVisualId,
                        principalTable: "Novelas",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comentarios_NovelaVisualId",
                table: "Comentarios",
                column: "NovelaVisualId");
